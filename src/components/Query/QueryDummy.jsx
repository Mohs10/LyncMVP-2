  ...
  const queries = [
    {
      ...
      timeline: [
        ...
        { time: '8:00pm', date: '19th Aug 2024', description: 'Order Placed', actions: ['View Details', ] },
        { time: '6:00pm', date: '19th Aug 2024', description: 'Sample Requested', actions: ['Notify Buyer','View Details'] },
  ...
  const handleActionClick = (action, event) => {
    switch (action) {
      ...
      case 'View Price Updates':
        ...
        break;
        case 'Notify Buyer':
          navigate(`/notify-buyer/${selectedQuery}`);
          break;
      case 'View Details':
